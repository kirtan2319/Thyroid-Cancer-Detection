...
parser.add_argument('--source_dataset', type=str, default='Thy', help='source dataset name')
parser.add_argument('--target_dataset', type=str, default='Thy', help='target dataset name')
parser.add_argument('--sensitive_name', type=str, default='Sex', help='dataset name')
...
model_path = r'C:\Users\saium\Desktop\thyroid\fairness_data\model_records\{datas}\{attr}\{bkbone}\\'.format(
